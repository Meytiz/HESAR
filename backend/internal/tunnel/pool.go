...
// may be *established* (outbound Dial + secure handshake, or inbound
// handshake + local dial) at the same time, per tunnel instance.
//
// Background
// ----------
// Every listener in this package (TCP, KCP, QUIC, TLS-fallback) used to do
